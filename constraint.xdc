...
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN P16 [get_ports {btn_load_y}];  # "BTNC"
set_property PACKAGE_PIN R16 [get_ports {btn_start}];  # "BTND"
set_property PACKAGE_PIN N15 [get_ports {btn_load_x}];  # "BTNL"
set_property PACKAGE_PIN R18 [get_ports {btn_toggle_k}];  # "BTNR"
